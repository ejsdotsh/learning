...
// the lexer and builds the AST starting from the root node.
...
// helper methods to populate *fixParseFn map
...
// ParseProgram parses the input tokens and returns the complete AST.
...
// Errors checks if the parser encountered any errors.
